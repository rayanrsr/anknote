...
class NoteCard(BaseModel):
    ...
    output_path: Optional[Path] = Field(None, description="Path where the TSV file will be saved")
    note: str = Field(default="", description="Content of the markdown note")
    cards: Optional[list[dict[str, str]]] = Field(None, description="Generated flashcards")
