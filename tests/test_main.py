...
class TestCustomPrompt:
    ...
    def test_load_custom_prompt_file(self, tmp_path):
    ...
    def test_load_empty_prompt_file(self, tmp_path):
...
class TestMainFunction:
    ...
    def test_main_success(self, mock_console, mock_generate, mock_retrieve, tmp_path):
    ...
    def test_main_no_files(self, mock_console, mock_generate, mock_retrieve, tmp_path):
    ...
    def test_main_keyboard_interrupt(self, mock_console, mock_generate, mock_retrieve, tmp_path):
