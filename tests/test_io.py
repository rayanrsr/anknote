...
class TestNoteCard:
    ...
    def test_create_note_card(self, tmp_path):
    ...
    def test_note_card_str(self, tmp_path):
...
class TestRetrieveInput:
    ...
    def test_retrieve_single_file(self, tmp_path):
    ...
    def test_retrieve_directory(self, tmp_path):
...
class TestSaveAsAnki:
    ...
    def test_save_no_cards(self, tmp_path):
...
class TestSplitCards:
    ...
    def test_split_valid_cards(self):
    ...
    def test_split_malformed_cards(self):
    ...
    def test_split_no_valid_cards(self):
...
class TestGenerateFlashcards:
    ...
    def test_generate_success(self, mock_completion, tmp_path):
        ...
        card = NoteCard(
            input_path=tmp_path / "test.md",
            note="Test content for generation"
        )
    ...
    @patch('anknote.io.write.completion')
    def test_generate_empty_note(self, mock_completion, tmp_path):
    ...
    @patch('anknote.io.write.completion')
    def test_generate_retry_on_failure(self, mock_completion, tmp_path):
        """Test retry mechanism on failure."""
        # First call fails, second succeeds
        mock_completion.side_effect = [
            Exception("API Error"),
            MagicMock(choices=[MagicMock(message=MagicMock(content="<START>Q <PROMPT-END> A <ANSWER-END><END>"))])
        ]
    ...
    @patch('anknote.io.write.completion')
    def test_generate_max_retries_exceeded(self, mock_completion, tmp_path):
